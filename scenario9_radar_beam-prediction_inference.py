...
from radar_network_models import LeNet_RangeAngle, LeNet_RangeVelocity, Advenced_RadarCube
...
# Solution Type Selection / Automatically extracted fexrom folder name
data_type = int(model_folder.split('_')[2][-1]) # 0: Radar Cube / 1: Range Velocity / 2: Range Angle
...
neural_nets = [Advenced_RadarCube, LeNet_RangeVelocity, LeNet_RangeAngle]
